...
use glam::DVec3;
use mc173_module::entity::{EntityKind, Entity, Hurt, LivingKind, ProjectileKind};
...
/// so we split it here.
pub(super) fn tick_state(id: u32, entity: &mut Entity) {
    match entity {
        // Entity(_, BaseKind::Living(_, _)) => tick_state_living(world, id, entity),
        Entity(_, _) => tick_state_base(id, entity),
    }
}

/// REF: Entity::onEntityUpdate
fn tick_state_base(id: u32, entity: &mut Entity) {
...
fn spawn_many_loot(pos: DVec3, stack: ItemStack, count: usize) {
    for _ in 0..count {
